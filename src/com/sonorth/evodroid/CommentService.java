...
public class CommentService extends Service {
	...
	/** don't forget to fire update to the ui listener */
	private void _getUpdatedComments() {
    	
    	Vector<?> notificationAccounts = b2evolution.DB.getNotificationAccounts(this);
    	...
    	if (notificationAccounts != null){
    		...
    		for (int i = 0; i < notificationAccounts.size(); i++)
    		{
    			...
    			//Log.i("b2evolutionCommentService", "Checking Comments for " + accountName);
        ...
        XMLRPCMethodCallback callBack = new XMLRPCMethodCallback() {
			...
			public void callFinished(Object[] result) {
				HashMap<?, ?> notificationOptions = b2evolution.DB.getNotificationOptions(CommentService.this);
				...
				if (latestCommentID == 0){
					b2evolution.DB.updateLatestCommentID(accountID, Integer.valueOf(commentID));
					//Log.i("b2evolutionCommentService", "comment was zero");
				}
					...
					Intent notificationIntent = new Intent(CommentService.this, Comments.class);
    		  		notificationIntent.setData((Uri.parse("custom://b2evolutionNotificationIntent"+accountID)));
    		  		...
    		  		n.flags |= Notification.FLAG_AUTO_CANCEL;
 			  		...
 			  		b2evolution.DB.updateLatestCommentID(accountID, Integer.valueOf(commentID));
					//Log.i("b2evolutionCommentService", "found a new comment!");
				}
				else{
					//Log.i("b2evolutionCommentService", "no new comments");
				}
