...
public class ViewCommentFragment extends Fragment {
	...
	public void onResume() {
		...
		if (b2evolution.currentComment != null) {
			loadComment(b2evolution.currentComment);
	...
	private void processCommentStatus() {
		...
		if (b2evolution.currentComment != null) {
			if (b2evolution.currentComment.status.equals("hold")) {
				unapprove.setVisibility(View.GONE);
				approve.setVisibility(View.VISIBLE);
				spam.setVisibility(View.VISIBLE);
			} else if (b2evolution.currentComment.status.equals("approve")) {
				approve.setVisibility(View.GONE);
				unapprove.setVisibility(View.VISIBLE);
				spam.setVisibility(View.VISIBLE);
			} else if (b2evolution.currentComment.status.equals("spam")) {
